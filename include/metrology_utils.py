...
def get_lat_long_for_cityname(city: str):
    """Converts a stribg of a city name provided into lat/long coordinates."""
    ...
    try:
        ...
        # long the coordinates retrieved
        gv.task_log.info(f"Coordinates for {city} are: {lat}, {long}")
...
def get_current_weather_from_city_coordinates(coordinates, timestamp):
    """Queries the open-meteo API for the current weather at the
