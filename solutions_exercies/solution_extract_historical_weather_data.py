...
from include.metrology_utils import (
...
def solution_extract_historical_weather_data():
    ...
    def get_lat_long_for_city(city):
        ...
        'metrological_utils' module to retrieve the coordinates for the given city.
        """
    ...
    def get_historical_weather(coordinates):
        ...
        'metrological_utils' module to retrieve the historical weather in a city.
        """
        
        historical_weather_and_coordinates = (get_historical_weather_from_city_coordinates(coordinates))
    ...
    turn_json_into_table(
        ...
        output_table=Table(name=c.IN_HISTORICAL_WEATHER_TABLE_NAME, conn_id=gv.CONN_ID_DUCKDB),)   
